<?php if ( $wp_query->max_num_pages > 1 ) : ?>
	<!--<div id="nav-above" class="navigation">
		<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&lt;&lt;&lt;</span> Older Posts', 'atmosphere' ) ); ?></div>
		<div class="nav-next"><?php previous_posts_link( __( 'Newer Posts <span class="meta-nav">&gt;&gt;&gt;</span>', 'atmosphere' ) ); ?></div>
	</div>
	-->
	<!-- #nav-above -->
<?php endif; ?>
			...
			<div class="entry-utility">
				<?php if ( count( get_the_category() ) ) : ?>
					<span class="cat-links">
						 <?php atmosphere_posted_on(); ?> in  
						<?php printf( __( '%2$s', 'atmosphere' ), 'entry-utility-prep entry-utility-prep-cat-links', get_the_category_list( ', ' ) ); ?>
					</span>
				<?php endif; ?>
				<?php
