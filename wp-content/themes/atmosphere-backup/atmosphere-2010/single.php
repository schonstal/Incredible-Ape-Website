...
<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				...
				<div id="nav-above" class="navigation">
					<div class="nav-previous"><?php previous_post_link( '%link', '<span class="meta-nav">' . _x( '&laquo;', 'Previous post link', 'atmosphere' ) . '</span> %title |' ); ?></div>
					<div class="nav-next"><?php next_post_link( '%link', '| %title <span class="meta-nav">' . _x( '&raquo;', 'Next post link', 'atmosphere' ) . '</span>' ); ?></div>
				</div><!-- #nav-above -->
						...
						<div id="author-description">
							...
							<div id="author-link">
								<a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>">
									<?php printf( __( 'View all posts by %s <span class="meta-nav">&raquo;</span>', 'atmosphere' ), get_the_author() ); ?>
								</a>
							</div><!-- #author-link	-->
